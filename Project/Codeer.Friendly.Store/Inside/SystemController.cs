...
namespace Codeer.Friendly.Store.Inside
{
    ...
    class SystemController
    {
        ...
        internal SystemController(IntPtr systemControlWindowInAppHandle)
        {
            ...
            {
                throw new FriendlyOperationException(Resources.ErrorExecuteThreadWindowHandle);
            }
        }
        ...
        internal FriendlyConnectorCore StartFriendlyConnector(IntPtr executeThreadWindowHandle, ReceiveAfterSend receive)
        {
            //通信用ウィンドウを生成
            ...
            return new FriendlyConnectorCore(_friendlyConnectorWindowInAppAsync, friendlyConnectorWindowInApp, receive);
        }
