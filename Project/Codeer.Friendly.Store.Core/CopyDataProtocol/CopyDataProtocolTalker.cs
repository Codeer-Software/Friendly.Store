...
namespace Codeer.Friendly.Store.Core.CopyDataProtocol
{
	...
	/// Windowメッセージ通信。
	/// </summary>
	public static class CopyDataProtocolTalker
	{
		/// <summary>
		/// 送受信。
		/// </summary>
        ...
        public static object SendAndRecieve(IntPtr targetWindowHandle, object data)
		{
		...
		/// <returns>受信データ。</returns>
        public static object SendAndRecieve(IntPtr targetWindowHandle, object data, ReceiveAfterSend recieveWindow)
		{
            //通信番号生成
