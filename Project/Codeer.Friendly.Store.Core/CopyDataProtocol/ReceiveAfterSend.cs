...
namespace Codeer.Friendly.Store.Core.CopyDataProtocol
{
	...
	/// 送信後の返信受信。
	/// </summary>
	public class ReceiveAfterSend : ReceiveForm
	{
        ...
        /// 通信番号管理用。
        /// </summary>
        public UniqueNoManager UniqueNoManager { get { return _uniqueNoManager; } }
        ...
        /// <returns>成否。</returns>
        public bool GetReceiveData(int communicationNo, out object receieveData)
        {
