...
namespace Codeer.Friendly.Store.Core.CopyDataProtocol
{
	...
	/// データ受信ウィンドウ共通処理。
	/// </summary>
    public abstract class ReceiveForm : CommunicationWindow
	{
		/// <summary>
		/// WM_COPYDATA送信成功。
		/// </summary>
        public static readonly IntPtr SendCopyDataSuccess = new IntPtr(1);
        ...
        /// 使用可能なスレッドであるか
        /// </summary>
        public bool CanUseThread { get { return _managedThreadId == Thread.CurrentThread.ManagedThreadId; } }
